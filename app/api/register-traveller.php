...
if ($method === "POST") {
    ...
    if ($existingUser) {
        send_res(400, ["message" => "Email already exists"]);
    }
    ...
    set_cookie_helper('apiKey', $apiKey);
    send_res(200);
}