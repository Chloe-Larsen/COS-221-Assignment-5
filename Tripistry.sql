...
(1,'Cape Escape','3-day Cape Town tour',4999.99,3,NULL,1),
(2,'Joburg Nights','City nightlife experience',2999.99,2,NULL,2),
(3,'Safari Adventure','Wildlife experience trip',8999.99,5,NULL,3),
(4,'Coastal Relax','Beach holiday package',6500.00,4,NULL,4);
...
(1,'Bella Italia',1,12,'Main Road','Sandton','2196'),
(2,'Golden Dragon',2,44,'Market Street','Johannesburg','2001'),
(3,'Braai House',3,8,'Heritage Rd','Pretoria','0001'),
(4,'Burger Hub',4,55,'Central Ave','Cape Town','8001');
...
-- Dump completed on 2026-05-13  1:36:09
